...
public class DatabaseUtil {
	...
	// These should never be stored directly in code. I am doing this quickly
	// complete the
	// demonstration code. The appropriate solution is to store these values in
	// environment
	...
	public final static String dbName = "management"; // Whatever Schema you created in tutorial.
	...
	/**
	 * Singleton access to DB connection to share resources effectively across
	 * multiple accesses.
	 */
	protected static Connection connect() throws Exception {
		...
		// this is resistant to any SQL-injection attack since we choose one of two
		// possible ones.
