    ...
    render() {
        ...
        if (this.subtasks.length > 0) {
            ...
            <div class="list-group-item">
                ...
                <button type="button" class="btn btn-secondary btn-sm float-end" id="renameButton-${this.id}" data-bs-target="#renameTaskModal" data-bs-toggle="modal" onclick="project.rename('${this.id}')">Rename</button>
            </div>
            ${subtaskstring}
            `
        } else {
            ...
            <div class="list-group-item">
                ...
                <button type="button" class="btn btn-dark btn-sm" id="markButton-${this.id}" onclick="project.mark('${this.id}')" style="margin-right: 5px">${completedstring}</button><b>${this.position}</b> ${this.title} 
                <button type="button" class="btn btn-secondary btn-sm float-end" id="renameButton-${this.id}" data-bs-target="#renameTaskModal" data-bs-toggle="modal" onclick="project.rename('${this.id}')" style="margin-bottom: 2px">Rename</button>
                </p>
                <div>
